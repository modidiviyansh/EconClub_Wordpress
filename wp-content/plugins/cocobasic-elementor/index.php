...
/**
 * Plugin Name: CocoBasic - Pekko Elementor Widgets 
 * Description: Custom Elementor Widgets used in Pekko WordPress Theme.
 * Version: 1.0
 * Author: CocoBasic
...
if (!class_exists('CocoBasicLandingAddons')) :
    ...
    final class CocoBasicLandingAddons {
        ...
        public function cocobasic_frontend_enqueue_script() {
            ...
            wp_enqueue_style('swiper', PM_PLUGIN_URL . 'assets/css/swiper.min.css');
            ...
            wp_enqueue_script('swiper', PM_PLUGIN_URL . 'assets/js/swiper.min.js', '', '', true);
            wp_enqueue_script('istope.pkgd', PM_PLUGIN_URL . 'assets/js/isotope.pkgd.js', '', '', true);
